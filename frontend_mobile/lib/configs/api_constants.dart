class ApiConstants {
  ...
  static const String addPrescription =
      '$BASE_URL/api/v1/user/upload-prescription';
  static const String addLabReports = '$BASE_URL/api/v1/user/upload-lab-report';
  static const String getAllPrescriptions =
      '$BASE_URL/api/v1/user/prescription/all';
  static const String getPrescription =
      '$BASE_URL/api/v1/user/prescription/byId';
  ...
  static const String getUser = '$BASE_URL/api/v1/user/byId';
}
